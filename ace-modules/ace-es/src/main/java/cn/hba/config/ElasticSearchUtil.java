...
public class ElasticSearchUtil {
    ...
    private static TransportClient client = new ElasticsearchBase().init();
     ...
     * @param index 索引名
     */
    public static boolean verifyIndexExist(String index) {
     ...
     */
    public static String getOneDocument(String index, String type, String id) {
        // 搜索数据
